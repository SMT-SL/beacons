...
import com.smt.beaconsmagnum.adapters.LeDeviceListAdapter;
import com.smt.beaconsmagnum.services.BeaconsMonitoringService;
...
//        beaconManager = new BeaconManager(this);
        ...
        runInBackBtn.setVisibility(View.GONE);
...
//		});
    ...
    protected void onStart() {
      ...
      if (!beaconManager.hasBluetooth()) {
        Toast.makeText(this, "El dispositivo no soporta Bluetooth Low Energy, los beacons no ser�n detectados", Toast.LENGTH_LONG).show();
        return;
      }
...
//      		    bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
				...
				stopService(intent);
      		    ...
      		    //Simulamos el tiempo de conexi�n al servidor...
