...
public interface IBeaconListener {
	 ...
	 * 
	 * @param ibeacon
	 *            Information about the iBeacon whose region has been entered
	 */
	 ...
	 * 
	 * @param ibeacon
	 *            Information about the iBeacon whose region has been left
	 */
	 ...
	 * 
	 * @param state
	 *            The state, either <code>SEARCH_STARTED</code>,
	 *            <code>SEARCH_END_EMPTY</code> or
	 *            <code>SEARCH_END_SUCCESS</code>
	 */
	public void searchState(int state);

	/**
	 * Called to notify an error in the iBeacon protocol, probably due to the
	 * BluetoothAdapter
	 * 
	 * @param status
